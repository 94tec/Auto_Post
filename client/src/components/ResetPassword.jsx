...
export default function ResetPassword() {
  ...
  const renderContent = () => {
    const commonClasses = "w-full max-w-[500px] bg-[#0c0c1e]/90 backdrop-blur-sm rounded-2xl p-8 text-white shadow-2xl border";
    const iconSize = 48;
      ...
      case 'valid':
        return (
          <motion.div
            ...
            className={`${commonClasses} border-white/10`}
          >
            <button
      ...
      case 'invalid':
        return (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className={`${commonClasses} border-red-500/30`}
          >
            <div className="flex flex-col items-center space-y-4">
