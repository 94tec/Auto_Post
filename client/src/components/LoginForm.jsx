        ...
        {showResetForm ? (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full text-center text-[#F59E0B] text-sm hover:text-[#F97316] transition-colors"
            >
              Back to Login
            </button>
          </div>
              ...
              {isLoading ? (
                <>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="h-5 w-5 border-2 border-gray-950 border-t-transparent rounded-full animate-spin" />
                  </div>
                </>
              ) : (
                'Login'
